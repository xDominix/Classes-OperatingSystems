...
FILE * raportFile;
const char *raportName = "./raport3a.txt";
...
int main(int argc,char **argv) {
    ...
    if(!handle){ error("handle error"); };

    struct BlockArray (* createBlockArray)() = (struct BlockArray (*)())dlsym(handle, "createBlockArray");
    struct Block (*wcFile)()  = (  struct Block (*)())dlsym(handle, "wcFile");
    int (*addBlock)() = ( int (*)())dlsym(handle, "addBlock");
