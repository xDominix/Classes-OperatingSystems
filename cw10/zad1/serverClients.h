#ifndef SERVERCLIENTS_H
#define SERVERCLIENTS_H
#include <string.h>
#include <unistd.h>
...
typedef enum{ LOCAL, WEB, NONE } ClientConnectionType;
...
serverClientsList * cliList_create(){  return NULL; }
...
{
    if(cliList == NULL)  return NULL;
    if(strcmp(cliList->clientName, name) == 0) return cliList;
